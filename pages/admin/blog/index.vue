  ...
  <div>
    ...
    <form class="form">
      <div class="field is-grouped">
        <div class="control">
          <nuxt-link to="/admin/blog/new" class="button is-success">
            <span class="icon">
    ...
    <table class="table is-striped is-hoverable is-fullwidth">
      ...
      <tbody>
        <tr v-for="post in posts" :key="post._id">
          <td>
            <a :href="'/blog/' + post.slug" target="_blank">{{post.title || post.slug}}</a>
          </td>
          <td>
            ...
            <div class="dropdown is-hoverable is-right">
              ...
              <div class="dropdown-menu" id="dropdown-menu" role="menu">
                <div class="dropdown-content">
                  <nuxt-link :to="'/admin/blog/' + post._id" class="dropdown-item">
                    <span class="icon">
